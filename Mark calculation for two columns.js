...
* the script asks to enter 2 numbers: 1 - the ordinal number of the first column, 
* and 2 - the ordinal number of the second column, 
* the arithmetic average will be calculated on those two columns for each student 
...
function calculateAverage(students) {
    ...
    const results = students.map(student => {
        const grades = [
            student.grades[start - 1], 
            student.grades[finish - 1] 
        ].filter(grade => grade !== '');
